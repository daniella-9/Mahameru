      ...
      <div class="container">
        ...
        <form @submit.prevent="createNewUser()" method="POST" enctype="multipart/form-data">
          <div class="input-group">
            ...
            <ion-input type="text" name="nickname" placeholder="Masukkan Nickname Anda" v-model="form['nickname']">
            </ion-input>
          </div>
          <div class="input-group">
            <ion-label>Phone Number</ion-label>
            <ion-input type="tel" name="notelp" placeholder="Masukkan Nomor Telepon" v-model="form['notelp']">
            </ion-input>
          </div>
          <div class="input-group">
            <ion-label>Pin</ion-label>
            <ion-input type="password" name="pin" placeholder="Masukkan Pin" v-model="form['pin']">
            </ion-input>
          </div>
          <div class="input-group">
            <ion-label>Full Name</ion-label>
            <ion-input type="text" name="name" placeholder="Masukkan Nama Lengkap" v-model="form['name']">
            </ion-input>
          </div>
          <br><br>
          <div>
            <button type="submit" class="button-reg" @click="navigateToHome()">Register</button>
          </div>
        </form>
        <!-- @click="createNewUser()" -->
      </div>
